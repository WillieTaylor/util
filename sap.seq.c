...
int	i, j, n, id;
	...
	rms = supermac(ww,va,vb,len,ac,bc,rot);
	printf("%s Un-weighted RMSd = %7.3f over all %d matched atoms ( %f  %5.1f )\n", pdbcode, rms, n, sum, pct);
	return rms;
}
