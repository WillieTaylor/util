/*
cc -O sapSEQ.c -o sapSEQ util/aa/cones.o util/aa/stutest.o util/aa/bestrot.o util/wt/util.o util/wt/geom.o util/wt/sort.o util/aa/pdbprot.o util/aa/matrix.o util/aa/siva.o util/aa/ql.o util/eigen.o -lm
	...
	lenb = seqb->len;
        ...
        for (i=3; i<lenb-1; i++) {
		  ...
		  int	ra, rb;
			...
			if (ra == rb) bias[i][j] *= 10.0; else bias[i][j] *= 0.1;
			sim[i][j] = bias[i][j];
                        if (self)
                        { float off;
                                if (i>=j) {
