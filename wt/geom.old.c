...
Mrot ( axis, R, r ) char axis; Mat *R; float r; {
...
float dist2line (a,b,c,d) Vec a,b,c,d; {
...
int dot2pair (a,b,c,g,h) Vec a,b,c, *g,*h; {
...
float old_lineOline (a,b,c,d,box) Vec a,b,c,d, *box; {
/* return overlap length for line segments a-b and c-d */
Vec x, y, z;
Mat M[1], W[1];
float lap, det, aa, ga, gb, hc, hd, r, s, t[4];
...
float endOline (a,b,c) Vec a,b,c; {
...
float rotate (a,b,c,t)  Vec a, b, *c; float t; {
...
separate (a,b,dist,kick) Vec *a, *b; float dist, kick;
{
